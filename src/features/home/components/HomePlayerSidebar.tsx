...
export default function HomePlayerSidebar({ isPlayerVisible, setIsPlayerVisible }: HomePlayerSidebarProps) {
  return(
    <aside
    className={`
    ...
    <div className="p-4 flex flex-col gap-4 h-full">
        ...
        <h3 className="text-white font-semibold text-lg">I Don’t Care</h3>
        <button
        ...
        {[
            ...
            className={`
                ...
                ${song.active ? 'bg-white/10' : 'bg-transparent'}
            `}
            >
            <img
                src="https://i.scdn.co/image/ab67616d0000b273e0f4e8f7a7e6f8a6c5b6f5a5"
